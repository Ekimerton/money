                    ...
                    {history.map((session) => {
                        ...
                        return (
                            <div key={session.fetched_at} className="first:pt-0 pt-4 last:border-b-0">
                                <div className="px-4 pb-1 pt-4 text-xs text-neutral-950 dark:text-neutral-50 font-semibold uppercase tracking-wider">
                                    {dateLabel}
                                </div>
                                <div className="px-4 grid gap-1 mb-2">
                                    <h1 className="text-3xl sm:text-4xl font-bold text-neutral-950 dark:text-neutral-50">
                                ...
                                <div className="space-y-4">
                                    {session.transactions.length > 0 ? (
                                        ...
                                        <p className="text-sm text-muted-foreground italic px-5 mb-4">No individual transactions recorded for this sync pulse.</p>
                                    )}
                                </div>
                            </div>
                        );
